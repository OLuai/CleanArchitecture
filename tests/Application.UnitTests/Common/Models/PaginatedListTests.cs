...
public class PaginatedListTests
{
    ...
    [Test]
    public void PageSizeAndTotalCount_ShouldBeExposed()
    {
        var list = new PaginatedList<int>([1, 2, 3], 100, pageNumber: 2, pageSize: 10);
    ...
    [Test]
    public void TotalPages_ShouldBeZero_WhenPageSizeIsNotPositive()
    {
        var list = new PaginatedList<int>([], 100, pageNumber: 1, pageSize: 0);
