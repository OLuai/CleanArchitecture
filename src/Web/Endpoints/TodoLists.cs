...
public class TodoLists : IEndpointGroup
{
    public static void Map(RouteGroupBuilder groupBuilder)
    {
        ...
        groupBuilder.MapGet(GetTodoLists)
            .RequireAuthorization($"Permission:{Permissions.TodoLists.View}");
        groupBuilder.MapPost(CreateTodoList)
            .RequireAuthorization($"Permission:{Permissions.TodoLists.Create}");
        groupBuilder.MapPut(UpdateTodoList, "{id}")
            .RequireAuthorization($"Permission:{Permissions.TodoLists.Update}");
        groupBuilder.MapDelete(DeleteTodoList, "{id}")
            .RequireAuthorization($"Permission:{Permissions.TodoLists.Delete}");
    }
